...
<body background="images/bg.jpg" bgproperties="fixed" style="font-family: arial;">
...
require 'menubar.php';
?>
<br /><br /><br /><br /><br /><center><fieldset style="border-bottom: hidden;border-right: hidden;border-left: hidden;width:50%;border-color:black;border-width:3px;"><legend><h2>Chinese Menu</h2></legend></fieldset></center>
...
$qry="select item_code,item_name,item_price from items where item_code like 'C%'";
