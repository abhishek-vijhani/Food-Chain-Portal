...
require 'menubar.php';
?>
<br /><br /><br /><br /><br /><center><fieldset style="border-bottom: hidden;border-right: hidden;border-left: hidden;width:50%;border-color:black;border-width:3px;"><legend><h2>Beverage Menu</h2></legend></fieldset></center>
...
$qry="select item_code,item_name,item_price from items where item_code like 'B%'";
